...
const Loader = () => {
  const loaderCss = `
    .loader {
      --duration: 3s;
      /* Cream #f5f5f0 on dark #0a0a0a background — matches MTM Studio palette */
      --primary: rgba(245, 245, 240, 1);
      --primary-light: rgba(210, 210, 205, 1);
      --primary-rgba: rgba(245, 245, 240, 0);
      width: 200px;
      height: 320px;
      position: relative;
    ...
    .loader:before, .loader:after {
      ...
      right: 32%;
      bottom: -11px;
      /* CRITICAL: must match the page background so the masking trick works */
      background: #0a0a0a;
